  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <label className="text-sm text-[var(--color-text-secondary)] font-medium">Upload to folder:</label>
        <div className="flex gap-2 flex-wrap">
          ...
          <button
            ...
            disabled={disabled || isUploading}
            className="w-10 h-10 rounded-lg border-2 border-dashed border-[var(--color-border)] text-[var(--color-text-secondary)] hover:border-[var(--color-primary)] hover:text-[var(--color-primary)] transition-colors flex items-center justify-center"
        ...
        <span className="text-xs text-[var(--color-text-secondary)]">Files will be auto-numbered (e.g., {selectedFolder}-1, {selectedFolder}-2...)</span>
      </div>
      ...
      >
        ...
        {isUploading ? (
          <div className="space-y-3">
            <div className="animate-spin rounded-full h-10 w-10 border-3 border-[var(--color-primary)] border-t-transparent mx-auto"></div>
